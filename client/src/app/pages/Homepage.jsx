  ...
  if (loader)
    return (
      <div className='flex flex-col items-center px-2 md:px-16 2xl:px-96 py-3 justify-between'>
        ...
        <div className='w-full md:w-[90%] 2xl:w-[95%] flex items-center px-6 md:px-16 2xl:px-150 py-3 justify-between'>
          <Skeleton className='w-30! h-30! max-md:hidden rounded-full!' />
          <Skeleton className='w-30! h-30! max-md:hidden rounded-full!' />
          <Skeleton className='w-30! h-30! max-md:hidden rounded-full!' />
          <Skeleton className='w-30! h-30! max-md:hidden rounded-full!' />
          <Skeleton className='w-30! h-30! max-md:hidden rounded-full!' />
