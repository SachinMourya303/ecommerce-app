...
const Navbar = ({user , logout}) => {
    ...
    return (
        <div className={`flex items-center justify-between px-4 md:px-8 border-b border-amber-700 py-2 ${darkmode ? 'bg-black text-white' : 'bg-white text-black'} transition-all duration-300`}>
